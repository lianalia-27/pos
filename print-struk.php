...
$detailOrders = mysqli_query($koneksi, "SELECT order_details.*, products.product_name FROM order_details RIGHT JOIN products ON products.id = order_details.product_id WHERE order_id ='$order_id'");
...
<body onload="printAndClose()">
    <div class="struk">
        ...
        <div class="struk-footer">
            <div class="row">
                <span>Total</span>
                <span>Rp. <?= $dataOrder['order_amount'] ?></span>
            </div>
            <div class="row">
                <span>Bayar</span>
